...
-- License: MIT
-- Stresses: real-world DVD rental schema — domains (including Turkish-locale "bıgınt"), enum types, PL/pgSQL functions, aggregates, materialized views, views, triggers, tsvector columns, partial indexes, 17-table FK graph
